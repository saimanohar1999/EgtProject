...
heart_button->on_click([&main_screen,&startup_screen, &third_screen, &sensor_screen, &window1, &label0, &label3, &sizer0, &sizer1, &sizer2, &line1] (egt::Event &)
{
	//main_screen->hide();
//startup_screen->show();

	std::static_pointer_cast<egt::Window>(loader.load("window1"));
	window1.color(egt::Palette::ColorId::bg, egt::Color(0x1d2239ff));
